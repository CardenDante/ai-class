    ...
    <div className="min-h-screen bg-[var(--muted)]">
      ...
      <section className="relative py-16 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="inline-block px-4 py-2 bg-[var(--accent-coral)]/20 text-[var(--accent-coral)] rounded-full text-sm font-semibold mb-4">
            Interactive Learning
          </span>
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-4">
            AI Playground
          </h1>
          <p className="text-lg text-[var(--primary-200)] max-w-2xl mx-auto">
      ...
      <section className="py-8 -mt-8">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl shadow-xl border border-[var(--border)] overflow-hidden">
            {/* Chat Header */}
            <div className="bg-gradient-to-r from-[var(--primary-600)] to-[var(--primary-700)] px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">Powered by OpenAI</p>
                </div>
          ...
          {/* Example Prompts */}
          <div className="mt-8">
            <h3 className="text-lg font-semibold text-[var(--primary-950)] mb-4">
            ...
            <div className="flex flex-wrap gap-3">
              {examplePrompts.map((prompt, index) => (
                <button
                  ...
                  className="px-4 py-2 bg-white rounded-full border border-[var(--border)] text-sm text-[var(--muted-foreground)] hover:border-[var(--primary-400)] hover:text-[var(--primary-600)] transition-colors"
                >
                  {prompt}
                </button>
              ))}
